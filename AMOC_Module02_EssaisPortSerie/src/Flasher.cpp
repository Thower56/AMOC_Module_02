...
:m_pinDEL(p_aCopier.m_pinDEL), m_dureeAllumeeEteinte(p_aCopier.m_dureeAllumeeEteinte)
{
...
{
    Serial.println("Flasher::operator=(const Flasher& p_source) (0x" + String((uint16_t)this,HEX) + ")");
...
{
    //Serial.println("Flasher::faireClignoter(int p_nombreCycles) (0x" + String((uint16_t)this,HEX) + ")");
